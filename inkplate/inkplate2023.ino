...
void setup()
{
    ...
    // curl "https://gogo.jolos.fr/message?token=ADN6fT8HIancJgL" -F "title=my title" -F "message=my message" -F "priority=3"
    http.begin(client, "https://gogo.jolos.fr/message?token=ADN6fT8HIancJgL");
